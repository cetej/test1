...
class JointTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        image_rotary_emb: torch.FloatTensor = None, use_attn_res: bool = False,
    ):
        ...
        if use_attn_res:
            # In AttnRes mode, return sublayer outputs separately for the
            # AttnRes module to handle residual aggregation
            ...
            if self.context_pre_only:
                ...
                return encoder_hidden_states, hidden_states, attn_output, ff_output, None, None
            else:
                ...
                context_ff_output_gated = c_gate_mlp.unsqueeze(1) * context_ff_output
                encoder_hidden_states = encoder_hidden_states + context_ff_output_gated

                return encoder_hidden_states, hidden_states, attn_output, ff_output, context_attn_output, context_ff_output_gated
        else:
            hidden_states = hidden_states + attn_output
